...
$query="INSERT INTO `sellbattries`( `brand`, `year`, `descript`, `quantity`, `price`, `pic1`, `pic2`, `pic3`, `pic4`, `address`, `state`, `type`) VALUES ('$brand','$year','$description','$quantity','$price','$photo1Size','$photo2Size','$photo3Size','$photo4Size','$address','$state','$paper')";
